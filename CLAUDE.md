...
This project is indexed by GitNexus as **JaGit** (2337 symbols, 4204 relationships, 111 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
